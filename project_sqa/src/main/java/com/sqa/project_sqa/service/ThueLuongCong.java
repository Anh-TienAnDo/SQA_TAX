...
public class ThueLuongCong {
	...
	private final BigDecimal social_insurance = new BigDecimal("10.5");
	...
	public static String Tax_type1(BigDecimal taxable_income, BigDecimal deductible) { // thu nhập chịu thuế:
																							// taxable_income
		BigDecimal tax;
    ...
    public String Deductible(BigDecimal taxable_income, int dependent_person, BigDecimal benevolent) {
        BigDecimal deductible = taxable_income.multiply(this.social_insurance)
                ...
                .add(this.myself)
                .add(benevolent);
        return deductible.setScale(2, RoundingMode.HALF_UP).toString(); // Làm tròn số về 2 chữ số sau dấu thập phân
    }
