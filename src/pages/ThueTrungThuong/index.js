...
function ThueTrungThuong () {
    ...
    const handleFinish = async (values) => {
        let path = `api/to-khai-thue-tien-luong-cong/submit`;
    ...
    return(
        <>
            {contextHolder}
            <Card title="Khai báo thuế thu nhập từ trúng thưởng ">
...
export default ThueTrungThuong