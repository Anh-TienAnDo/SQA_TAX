        ...
        <div>
            ...
            <form className='form' onSubmit={handleSubmit}>
                <div>
                    ...
                    <input className='input' type="text" value={hoTen} onChange={(e) => setHoTen(e.target.value)} onClick={() => handleInputClick('hoTen')} />
                    {errors.hoTen && <span className="error-message">{errors.hoTen}</span>}
                </div>
                <div>
                    <label className='label'>Ngày tháng năm sinh:</label>
                    <input className='input' type="date" value={ngaySinh} onChange={(e) => setNgaySinh(e.target.value)} onClick={() => handleInputClick('ngaySinh')} />
                    {errors.ngaySinh && <span className="error-message">{errors.ngaySinh}</span>}
                </div>
                <div>
                    <label className='label'>Giới tính:</label>
                    <select className='select' onClick={() => handleInputClick('gioiTinh')} value={gioiTinh} onChange={(e) => setGioiTinh(e.target.value)}>
                ...
                <div>
                    <label className='label'>Giấy tờ cá nhân:</label>
                    <select className='select' onClick={() => handleInputClick('loaiGiayTo')} value={loaiGiayTo} onChange={(e) => setLoaiGiayTo(e.target.value)}>
                ...
                <div>
                    <label className='label'>{loaiGiayTo === 'cccd' ? 'Số CCCD:' : 'Số CMND:'}</label>
                    <input className='input' onClick={() => handleInputClick('soGiayTo')} type="text" value={soGiayTo} onChange={(e) => setSoGiayTo(e.target.value)} placeholder={loaiGiayTo === 'cccd' ? 'Số CCCD' : 'Số CMND'} />
                    {errors.soGiayTo && <span className="error-message">{errors.soGiayTo}</span>}
                </div>
                <div>
                    <label className='label'>Ngày cấp:</label>
                    <input className='input' onClick={() => handleInputClick('ngayCap')} type="date" value={ngayCap} onChange={(e) => setNgayCap(e.target.value)} placeholder="Ngày cấp" />
                    {errors.ngayCap && <span className="error-message">{errors.ngayCap}</span>}
                </div>
                <div>
                    <label className='label'>Nơi cấp:</label>
                    <input className='input' onClick={() => handleInputClick('noiCap')} type="text" value={noiCap} onChange={(e) => setNoiCap(e.target.value)} placeholder="Nơi cấp" />
                ...
                <div>
                    ...
                    <select className='select' onClick={() => handleInputClick('tinhThanhPhoHoKhau')} value={diaChiHoKhau.tinhThanhPho} onChange={(e) => {
                    ...
                    <select className='select' onClick={() => handleInputClick('quanHuyenHoKhau')} value={diaChiHoKhau.quanHuyen} onChange={(e) => {
                    ...
                    <select className='select' onClick={() => handleInputClick('xaPhuongHoKhau')} value={diaChiHoKhau.xaPhuong} onChange={(e) => setDiaChiHoKhau({ ...diaChiHoKhau, xaPhuong: e.target.value })}>
                    ...
                    <label className='label'>Số nhà/đường phố, thôn, xóm:</label>
                    <input className='input' onClick={() => handleInputClick('diaChiHoKhau')} type="text" value={diaChiHoKhau.soNhaDuong} onChange={(e) => setDiaChiHoKhau({ ...diaChiHoKhau, soNhaDuong: e.target.value })} placeholder="Số nhà/đường phố, thôn, xóm" />
                ...
                <div>
                    ...
                    <label className='label'>Tỉnh, thành phố:</label>
                    <select className='select' onClick={() => handleInputClick('tinhThanhPhoCuTru')} value={diaChiCuTru.tinhThanhPho} onChange={(e) => {
                    ...
                    <label className='label'>Quận, huyện:</label>
                    <select className='select' onClick={() => handleInputClick('quanHuyenCuTru')} value={diaChiCuTru.quanHuyen} onChange={(e) => {
                    ...
                    <label className='label'>Xã, phường:</label>
                    <select className='select' onClick={() => handleInputClick('xaPhuongCuTru')} value={diaChiCuTru.xaPhuong} onChange={(e) => setDiaChiCuTru({ ...diaChiCuTru, xaPhuong: e.target.value })}>
                        <option value="">Chọn xã, phường</option>
                    ...
                    <label className='label'>Số nhà/đường phố, thôn, xóm:</label>
                    <input className='input' onClick={() => handleInputClick('diaChiCuTru')} type="text" value={diaChiCuTru.soNhaDuong} onChange={(e) => setDiaChiCuTru({ ...diaChiCuTru, soNhaDuong: e.target.value })} placeholder="Số nhà/đường phố, thôn, xóm" />
                ...
                <div>
                    <label className='label'>Điện thoại liên hệ:</label>
                    <input className='input' onClick={() => handleInputClick('dienThoai')} type="tel" value={dienThoai} onChange={(e) => setDienThoai(e.target.value)} />
                ...
                <div>
                    <label className='label'>Cơ quan chi trả thu phận tại thời điểm đăng ký:</label>
                    <input className='input' onClick={() => handleInputClick('coQuanChiTra')} type="text" value={coQuanChiTra} onChange={(e) => setCoQuanChiTra(e.target.value)} />
            ...
            {registrationSuccess && (
                <div className="popup">
                    <div className="popup-content">
                        <h2>{popupTitle}</h2>
                        <p>{popupMessage}</p>
                        <button className='button' onClick={() => setRegistrationSuccess(false)}>Đóng</button>
                    </div>
                </div>
            )}
        </div>
