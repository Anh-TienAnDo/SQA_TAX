...
//    thuế thu nhập đối với cá nhân không cư trú
    ...
    public float Deductible(float taxable_income, int dependent_person, float benevolent) { // benevolent: khoản giảm trừ
        float deductible = (taxable_income / 100 * this.social_insurance) + (4400000 * dependent_person)
                + (this.myself) + benevolent;
